...
export const GEP_MODULE_NODES: GepModuleNode[] = [
  // ── Shell ──
  { id: 'GraphEditorPane.svelte', label: 'GraphEditorPane', cluster: 'shell', loc: 4465, kind: 'shell',
  ...
  { id: 'graph-history.svelte.ts', label: 'graph-history', cluster: 'shell', loc: 78, kind: 'state',
    role: '' },
  { id: 'PartsTableCard.svelte', label: 'PartsTableCard', cluster: 'shell', loc: 177, kind: 'component',
    role: '' },
  // ── Node cards ──
  { id: 'NodeCard.svelte', label: 'NodeCard', cluster: 'nodecard', loc: 2589, kind: 'component',
  ...
  { id: 'WireLayer.svelte', label: 'WireLayer', cluster: 'wiring', loc: 634, kind: 'component',
  ...
  { id: 'wire-delete.ts', label: 'wire-delete', cluster: 'wiring', loc: 90, kind: 'logic',
    role: '' },
  { id: 'wire-splice.ts', label: 'wire-splice', cluster: 'wiring', loc: 130, kind: 'logic',
    role: '' },
  // ── Sketch ──
  ...
  { id: 'SplineScene.svelte', label: 'SplineScene', cluster: 'spline', loc: 440, kind: 'component',
    role: 'Spline canvas/scene renderer' },
  { id: 'SplineEditorPopup.svelte', label: 'SplineEditorPopup', cluster: 'spline', loc: 225, kind: 'component',
  ...
  { id: 'BakeMenu.svelte', label: 'BakeMenu', cluster: 'bake', loc: 93, kind: 'component',
  ...
  // ── Right rail ──
  { id: 'RightPane.svelte', label: 'RightPane', cluster: 'rightrail', loc: 872, kind: 'component',
  ...
  // ── Geometry ──
  { id: 'geom.ts', label: 'geom', cluster: 'geometry', loc: 574, kind: 'logic',
...
export const GEP_MODULE_LINKS: GepModuleLink[] = [
  ...
  M('WireLayer.svelte', 'wire-delete.ts'),
  ...
  M('wire-splice.ts', 'wire-delete.ts'),
];
