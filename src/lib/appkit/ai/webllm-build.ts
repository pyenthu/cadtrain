...
// MODEL_ID / IS_QWEN3 live in ./webllm-model (imported above) so the worker + this driver agree.
// Currently Qwen2.5-1.5B-Instruct (~1.6 GB) — Qwen3-4B lost the WebGPU device on this GPU.
