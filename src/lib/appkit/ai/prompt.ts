...
export function emitInstruction(): string {
  ...
  return [
    ...
    'The example below shows the SHAPE of each op kind (meta, seed a variable, a DATA component reading',
    'it via a source, theme) — you build an app ACROSS MANY instructions like these, never all at once:',
