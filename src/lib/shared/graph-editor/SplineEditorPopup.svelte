...
<script lang="ts">
  ...
  import { splineArcLength, type Vec3 } from '$lib/graph/spline/spline-resample';
  import { parsePointsInput, pointsBbox, gridFor, snapVec3, type SplineView } from '$lib/graph/spline/spline-view';
