...
<script lang="ts">
  ...
  import {
    bezier, chipWidthFor, paramCardSize,
    cardMinWidth,
    sketchCols,
...
<style>
  ...
  /* Base + in-flight only — the static wire variants (obj/arg/child/param/
     param.expr/noderef/output/output.root/poly-rref) moved to WireLayer.svelte
     (modularize #940 CUT 1). The in-flight drag path stays here. */
