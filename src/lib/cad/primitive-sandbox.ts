...
export const SANDBOX_ARG_NAMES: string[] = [
  'M', 'cyl', 'tube', 'mv', 'rot', 'zMin', 'zMax', 'zLen', 'CIRCULAR_SEGMENTS_DEFAULT', 'CIRCULAR_SEGMENTS_COMPOSE',
...
export function sandboxArgValues(): any[] {
  return [
    helpers.M, helpers.cyl, helpers.tube, helpers.mv, helpers.rot, helpers.zMin, helpers.zMax, helpers.zLen,
