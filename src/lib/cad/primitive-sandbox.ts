...
export const SANDBOX_ARG_NAMES: string[] = [
  ...
  'gridPatch', 'capFan', 'weldAndBuild', 'revolveProfile', 'sweepAlongPath', 'sweepAnnular', 'boredSweep', 'loftStations', 'resampleSpline', 'resolveProfile', 'warpSpline', 'sectionCut',
...
export function sandboxArgValues(): any[] {
  return [
    ...
    gridPatch, capFan, weldAndBuild, revolveProfile, sweepAlongPath, sweepAnnular, boredSweep, loftStations, resampleSpline, resolveProfile, warpManifoldAlongSpline, helpers.sectionCut,
    cs, extrude_csg, ext, resample,
    compileSketch,
    helpers.tagManifold,
    globalThis, Math,
