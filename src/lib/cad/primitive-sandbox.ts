...
export const SANDBOX_ARG_NAMES: string[] = [
  ...
  'gridPatch', 'capFan', 'weldAndBuild', 'revolveProfile', 'sweepAlongPath', 'sweepAnnular', 'loftStations', 'resampleSpline', 'resolveProfile', 'warpSpline',
...
export function sandboxArgValues(): any[] {
  return [
    ...
    gridPatch, capFan, weldAndBuild, revolveProfile, sweepAlongPath, sweepAnnular, loftStations, resampleSpline, resolveProfile, warpManifoldAlongSpline,
    cs, extrude_csg, ext, resample,
    compileSketch,
    helpers.tagManifold,
    globalThis, Math,
