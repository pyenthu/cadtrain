export const meta = {
  ...
  description: 'Param-driven bolt (Option A demo): round shaft (r_cylinder) + hex head (r_extrude). The composite params drive the leaves; the head sits on the shaft top via a cross-param offset. Open the Parts tab and drag a slider — the resolved args re-link live; edit a part arg and Save to round-trip into the source.',
...
export function t_bolt_driven(shaft_od, shaft_len, head_thick) {
