...
Each runes primitive at `src/lib/graph/parts/<id>.ts` SHOULD have a
...
Strong example: `src/lib/graph/parts/conn_box.md`. Sparse example
that needs filling: `src/lib/graph/parts/enhanced_box.md`.
