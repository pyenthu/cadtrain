 ...
 * External dependency targets ($lib/graph/composition-graph, graph-to-tf, …) are
...
const TYPES_SRC = 'src/lib/graph/composition-graph-types.ts';
...
const NODE_NAMESPACES = [
  { ns: 'SolidProducers', classes: [
    ...
    { name: 'PartsMapNode',   fields: ['+string src', '+ArgValue list', '+Map~ArgValue~ argMap'] },
    { name: 'PartsTableNode', fields: ['+string src', '+string[] columns', '+Row[] rows'] },
  ] },
  ...
  { ns: 'Modifiers', classes: [
    { name: 'CutawayNode', fields: ['+NodeId child', '+ArgValue az', '+ArgValue offset'] },
  ] },
 ...
 *
 * Source of truth: src/lib/graph/composition-graph-types.ts. The GraphNode class
